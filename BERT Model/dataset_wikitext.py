...
class WikitextBertDataset(Dataset):
    """
    A class to represent the wikitext-103-v1 dataset
    ...
    def __init__(self, path, ds_from=None, ds_to=None, should_include_text=False):
        self.ds: pd.Series = pd.read_csv(path)['Paragraphs']
...
if __name__ == '__main__':
    ...
    ds = WikitextBertDataset(BASE_DIR.joinpath('train_output.csv'), ds_from=0, ds_to=50000,
